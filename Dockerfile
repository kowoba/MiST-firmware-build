...
RUN wget -q -O - https://raw.githubusercontent.com/mist-devel/mist-board/master/tools/install_arm-none-eabi-gcc.sh | \
    sed 's/--with-newlib/--with-newlib --enable-newlib-io-long-long/g' | bash -e
